//! Deep link import functionality for CC Gateway
//!
//! This module implements the ccgateway:// protocol for importing configurations
...
///
/// Represents a parsed ccgateway:// URL ready for processing.
