...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported privately through the repository's [Security Advisories](https://github.com/monologue1555/cc-gateway/security/advisories/new). All complaints will be reviewed and investigated promptly and fairly.
...
辱骂、骚扰或其他不可接受的行为可通过仓库的 [Security Advisories](https://github.com/monologue1555/cc-gateway/security/advisories/new) 私下报告。所有投诉都将得到及时和公平的审查和调查。
